  ...
  return (
    <div className="App">
      <div>
        ...
        <input type="text" placeholder="Senha..." onChange={(e) => setRegisterPassword(e.target.value)} />
        <button onClick={register}>Create User</button>
      </div>
      <div>
        <h3>Login</h3>
        <input type="text" placeholder="Email..." onChange={(e) => setLoginEmail(e.target.value)} />
        <input type="text" placeholder="Senha..." onChange={(e) => setLoginPassword(e.target.value)} />
